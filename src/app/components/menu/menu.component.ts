...
export class MenuComponent implements OnInit {
  ...
  protected entrees$ !: Observable<Product[]>;
  protected plats$!: Observable<Product[]>;
  protected desserts$!: Observable<Product[]>;
  protected boissons$!: Observable<Product[]>;
  ...
  protected constructor(private menuService: MenuService, public panierService: PanierService) {}
